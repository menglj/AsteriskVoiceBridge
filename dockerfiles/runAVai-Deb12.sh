...
echo "Attempting to run to container: $1 from AVai-Deb12 Image";

# forward ports for sip and rtp and the provider websocket.
docker run \
--name $1 \
--network=my-net -itd \
-p 5060:5060/udp \
asterisk-vai/deb12-asteriskvai bash
